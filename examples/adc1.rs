//! Read from ADC1 input pin PA_1 using DMA2 in circular mode.
//! Conversions are triggered by PWM from TIM2 channel 2, rising edge.
//! The 16 bit value is output to the ITM port.
...
// FIXME: Sample more ADC inputs than 1
const N: usize = 1;
